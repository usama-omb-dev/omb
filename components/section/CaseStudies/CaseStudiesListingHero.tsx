...
type CaseStudiesListingHeroProps = {
  className?: string;
  /** Published case studies in the current language (WordPress + Polylang). */
  publishedCaseStudyCount: number;
};

export default function CaseStudiesListingHero({
  className,
  publishedCaseStudyCount,
}: CaseStudiesListingHeroProps) {
    ...
    >
      <div className="container relative mx-auto px-4 lg:px-0">
        ...
        >
          ...
          <h1 className={titleClassName} aria-label={t("title")}>
